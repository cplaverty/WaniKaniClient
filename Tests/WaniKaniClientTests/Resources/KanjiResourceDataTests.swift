...
final class KanjiResourceDataTests: XCTestCase {
    func testDecode() throws {
        ...
        let expected = SubjectResource(
            ...
            data: KanjiResourceData(
                ...
                readings: [
                    KanjiReading(type: .onyomi, reading: "いち", isPrimary: true, isAcceptedAnswer: true),
                    KanjiReading(type: .kunyomi, reading: "ひと", isPrimary: false, isAcceptedAnswer: false),
                    KanjiReading(type: .nanori, reading: "かず", isPrimary: false, isAcceptedAnswer: false),
                    KanjiReading(type: .onyomi, reading: "いつ", isPrimary: true, isAcceptedAnswer: true)
                ],
                componentSubjectIDs: [1],
                amalgamationSubjectIDs: [2467, 2468, 2477, 2510, 2544, 2588, 2627, 2660, 2665, 2672, 2679, 2721, 2730, 2751, 2959, 3048, 3256, 3335, 3348, 3349, 3372, 3481, 3527, 3528, 3656, 3663, 4133, 4173, 4258, 4282, 4563, 4615, 4701, 4823, 4906, 5050, 5224, 5237, 5349, 5362, 5838, 6010, 6029, 6150, 6169, 6209, 6210, 6346, 6584, 6614, 6723, 6811, 6851, 7037, 7293, 7305, 7451, 7561, 7617, 7734, 7780, 7927, 8209, 8214, 8414, 8456, 8583, 8709, 8896, 8921, 9056, 9103],
        ...
        let resource = try ResourceDecoder.shared.decode(SubjectResource.self, from: testData)
    ...
    func testRoundTrip() throws {
        ...
        let decoded = try ResourceDecoder.shared.decode(SubjectResource.self, from: encoded)

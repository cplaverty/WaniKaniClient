...
final class RadicalTests: XCTestCase {
    ...
    func testDecode() throws {
        ...
        let resource = try decoder.decode(Subject.self, from: testData)
        
        let expected = Subject(id: 1,
                               ...
                               data: Radical(createdAt: makeUTCDate(year: 2012, month: 2, day: 27, hour: 18, minute: 8, second: 16),
                                             ...
                                             characters: "一",
                                             characterImages: [RadicalCharacterImage(url: URL(string: "https://cdn.wanikani.com/images/legacy/1054-subject-1-normal-weight-black-original.png?1520987606")!,
                                                                                     metadata: RadicalCharacterImageMetadata(color: "#000000", dimensions: "1024x1024", styleName: "original", inlineStyles: nil),
                                                                                     contentType: "image/png"),
                                                               RadicalCharacterImage(url: URL(string: "https://cdn.wanikani.com/images/legacy/1054-subject-1-normal-weight-black-1024px.png?1520987606")!,
                                                                                     metadata: RadicalCharacterImageMetadata(color: "#000000", dimensions: "1024x1024", styleName: "1024px", inlineStyles: nil),
                                                                                     contentType: "image/png"),
                                                               RadicalCharacterImage(url: URL(string: "https://cdn.wanikani.com/images/legacy/1054-subject-1-normal-weight-black-512px.png?1520987606")!,
                                                                                     metadata: RadicalCharacterImageMetadata(color: "#000000", dimensions: "512x512", styleName: "512px", inlineStyles: nil),
                                                                                     contentType: "image/png"),
                                                               RadicalCharacterImage(url: URL(string: "https://cdn.wanikani.com/images/legacy/1054-subject-1-normal-weight-black-256px.png?1520987606")!,
                                                                                     metadata: RadicalCharacterImageMetadata(color: "#000000", dimensions: "256x256", styleName: "256px", inlineStyles: nil),
                                                                                     contentType: "image/png"),
                                                               RadicalCharacterImage(url: URL(string: "https://cdn.wanikani.com/images/legacy/1054-subject-1-normal-weight-black-128px.png?1520987606")!,
                                                                                     metadata: RadicalCharacterImageMetadata(color: "#000000", dimensions: "128x128", styleName: "128px", inlineStyles: nil),
                                                                                     contentType: "image/png"),
                                                               RadicalCharacterImage(url: URL(string: "https://cdn.wanikani.com/images/legacy/1054-subject-1-normal-weight-black-64px.png?1520987606")!,
                                                                                     metadata: RadicalCharacterImageMetadata(color: "#000000", dimensions: "64x64", styleName: "64px", inlineStyles: nil),
                                                                                     contentType: "image/png"),
                                                               RadicalCharacterImage(url: URL(string: "https://cdn.wanikani.com/images/legacy/1054-subject-1-normal-weight-black-32px.png?1520987606")!,
                                                                                     metadata: RadicalCharacterImageMetadata(color: "#000000", dimensions: "32x32", styleName: "32px", inlineStyles: nil),
                                                                                     contentType: "image/png"),
                                                               RadicalCharacterImage(url: URL(string: "https://cdn.wanikani.com/images/legacy/576-subject-1-without-css-original.svg?1520987227")!,
                                                                                     metadata: RadicalCharacterImageMetadata(color: nil, dimensions: nil, styleName: nil, inlineStyles: false),
                                                                                     contentType: "image/svg+xml"),
                                                               RadicalCharacterImage(url: URL(string: "https://cdn.wanikani.com/images/legacy/98-subject-1-with-css-original.svg?1520987072")!,

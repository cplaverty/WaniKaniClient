...
final class StudyMaterialTests: XCTestCase {
    ...
    func testDecode() throws {
        ...
        let resource = try decoder.decode(StudyMaterial.self, from: testData)
        
        let expected = StudyMaterial(id: 204431,
                                     ...
                                     data: StudyMaterialData(createdAt: makeUTCDate(year: 2015, month: 7, day: 7, hour: 16, minute: 41, second: 2, microsecond: 579373),
                                                             subjectID: 25,
                                                             subjectType: .radical,

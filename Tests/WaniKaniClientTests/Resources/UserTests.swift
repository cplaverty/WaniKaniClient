...
final class UserTests: XCTestCase {
    ...
    func testDecode() throws {
        ...
        let resource = try decoder.decode(User.self, from: testData)
        
        let expected = User(url: URL(string: "https://api.wanikani.com/v2/user")!,
                            dataUpdatedAt: makeUTCDate(year: 2019, month: 6, day: 26, hour: 19, minute: 43, second: 27, microsecond: 724385),
                            data: UserData(id: "7d1742c5-c493-444b-97ae-c495bec9d850",
                                           username: "testUser",
                                           level: 24,
                                           ...
                                           subscription: UserSubscription(isActive: true,
                                                                          type: .recurring,
                                                                          maxLevelGranted: 60,
                                                                          periodEndsAt: makeUTCDate(year: 2020, month: 6, day: 12, hour: 7, minute: 40, second: 29)),
                                           preferences: UserPreferences(lessonsAutoplayAudio: true,
                                                                        lessonsBatchSize: 5,

...
final class ResetTests: XCTestCase {
    ...
    func testDecode() throws {
        ...
        let resource = try decoder.decode(Reset.self, from: testData)
        
        let expected = Reset(id: 1953,
                             ...
                             data: ResetData(createdAt: makeUTCDate(year: 2017, month: 8, day: 10, hour: 18, minute: 53, second: 51, microsecond: 328781),
                                             originalLevel: 2,
                                             targetLevel: 1,
